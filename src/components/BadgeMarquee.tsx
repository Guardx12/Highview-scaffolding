    ...
    <section className="py-6">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="relative mt-4 overflow-hidden">
          ...
          <div className="group">
            <div className="flex items-center gap-4 py-2 will-change-transform motion-safe:animate-[marqueeBadges_30s_linear_infinite] group-hover:[animation-play-state:paused] motion-reduce:animate-none">
              {loop.map((b, idx) => (
                <div
                  key={`${b.src}-${idx}`}
