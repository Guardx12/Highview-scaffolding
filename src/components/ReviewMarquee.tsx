    ...
    <section className="py-10">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="relative mt-6 overflow-hidden">
          ...
          <div className="group">
            <div className="flex gap-4 py-2 will-change-transform motion-safe:animate-[marquee_7s_linear_infinite] sm:motion-safe:animate-[marquee_34s_linear_infinite] group-hover:[animation-play-state:paused] motion-reduce:animate-none">
              {loop.map((r, idx) => (
